var TAU, Vect, aboutZero, approxBezierDisectionParameter, cube, cubicBezier, cubicBezierAtX, cubicDeCasteljau, invertedCubicDeCasteljau, lerp, lineX, lineY, rand, randInt, sq, v, vary;
...
aboutZero = function(x, tolerance) {
  if (tolerance == null) {
    tolerance = 0.001;
  }
...
v.rotateAngle = function(v1, a) {
  var cos, sin;
  cos = Math.cos(a);
  sin = Math.sin(a);
  return v(v1.x * cos - v1.y * sin, v1.x * sin + v1.y * cos);
};
